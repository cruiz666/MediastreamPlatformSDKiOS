...
//
//  Created by Carlos on 7/25/17.
//  Copyright © 2017 Mediastream. All rights reserved.
//
...
func callback(reachability:SCNetworkReachability, flags: SCNetworkReachabilityFlags, info: UnsafeMutableRawPointer?) {
    ...
    let reachability = Unmanaged<MediastreamPlayerReachability>.fromOpaque(info).takeUnretainedValue()
...
public class MediastreamPlayerReachability {
    public typealias NetworkReachable = (MediastreamPlayerReachability) -> ()
    public typealias NetworkUnreachable = (MediastreamPlayerReachability) -> ()
    ...
    fileprivate let reachabilitySerialQueue = DispatchQueue(label: "mediastre.am.reachability")
...
public extension MediastreamPlayerReachability {
    func startNotifier() throws {
        ...
        context.info = UnsafeMutableRawPointer(Unmanaged<MediastreamPlayerReachability>.passUnretained(self).toOpaque())
...
fileprivate extension MediastreamPlayerReachability {
