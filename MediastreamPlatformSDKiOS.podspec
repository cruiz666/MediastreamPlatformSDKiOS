...
Pod::Spec.new do |s|
    ...
    s.source           = { :http => 'https://s3.amazonaws.com/mediastream-platform-sdk-ios/sdk/1.0.77/MediastreamPlatformSDKiOS.zip' }
    ...
    s.dependency 'YouboraLib', '6.5.45'
    s.dependency 'YouboraAVPlayerAdapter', '6.5.28'
