...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MediastreamPlatformSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22MediastreamPlatformSDK11AppDelegate") SWIFT_AVAILABILITY(ios,introduced=10.0) SWIFT_AVAILABILITY(ios,introduced=10.0)
...
@interface AssetLoaderDelegate (SWIFT_EXTENSION(MediastreamPlatformSDK)) <AVAssetResourceLoaderDelegate>
...
SWIFT_CLASS("_TtC22MediastreamPlatformSDK23MediastreamCustomUIView")
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified defaulCastButton;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified castButtonContainer;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified customCastButtonContainer;
...
SWIFT_CLASS("_TtC22MediastreamPlatformSDK26MediastreamPlayerCollector")
@interface MediastreamPlayerCollector : NSObject
- (void)startCollectorPing;
- (void)stopCollectorPing;
- (void)CollectorTask;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC22MediastreamPlatformSDK24MediastreamPlayerTracker")
...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified videoContainer;
- (void)viewDidLoad;
- (void)requestedCc;
